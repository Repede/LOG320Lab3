...
public class Evaluator
{
	...
	{
		// --------------- NORMAL EVALUATOR --------------- 
		// Utilise l'approche par centre de masse, basÃ© sur https://pure.uvt.nl/portal/files/1216600/quad_ICCA_newsletter_vol_24_no_1.pdf
	/*	
...
/////////////////////////////////////////////////////////For each Color////////////////////////////////////////////////		
	...
	//	Float cencentrationBlack = 1/averageDistanceBlack;
		...
		// #TODO: Est-ce que l'on privilÃ©gie les boards dont les pieces sont plus proche du centre de masse avec un nombre de quad Ã©levÃ©s?
	...
	{
		// BasÃ© sur http://stackoverflow.com/questions/18591964/how-to-calculate-centroid-of-an-arraylist-of-points
	...
	public static float retrieveBoardEulerQuad(int board[][], int color){
		 ...
		 *  	- Pour l'instant, un quad est valide lorqu'un square possÃ¨de seulement la mÃªme couleur.
		 */
		...
		for(int i = 0 ; i < 7 ; i++)
		{
			for(int j = 0 ; j < 7 ; j++)
			{
				...
				else if( pastIsNotQuad3AndD && indexIJAresOdd)
				{
					...
					// FUCK THIS SHIT
					// sinon vÃ©rifie les quad extÃ©rieur ...
					else if(i>=1 && i<=5 && j>=1 && j<=5){
						// Aucun pion ne doit appartenir Ã  un quad3 ou un quadD
						// FUCK THIS SHIT
